...
See the header of this file for more information."
  ;; Spacemacs 0.3 removes the usage of `exec-path-from-shell' and
  ;; replaces it by a built-in function `spacemacs/load-spacemacs-env'
  ;; which reads variables from `~/.spacemacs.env'. Variables from
  ;; `~/.spacemacs.env' are generated by
  ;; `spacemacs//init-spacemacs-env'. See,
