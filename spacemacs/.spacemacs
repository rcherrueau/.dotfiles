...
are currently in."
  ...
  (with-eval-after-load 'ox
    ...
    ;; -- Export listings in a figure environment, using figure
    ;; caption (see case 4)
    ;;
    ;; https://github.com/fmdkdd/phd-thesis/blob/master/tex/export-setup.el#L34
    ;; Redefine `org-latex-src-block' with an advice to override the
    ;; way BEGIN_SRC blocks are exported. I need listings wrapped in a
    ;; figure environment for captions in the margin to work. And I
    ;; need to use the caption and label commands of the figure
    ;; environment rather than passed to the listings package. Changes
    ;; are in done in Case 4, below.
    ;; (require 'cl)                         ; for `case'
